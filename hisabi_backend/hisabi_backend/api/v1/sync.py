...
from hisabi_backend.utils.fx_defaults import resolve_default_fx_rate
...
def _resolve_fx_rate_for_wallet(
    *,
    ...
    default_rate = resolve_default_fx_rate(source, target)
    if default_rate and flt(default_rate) > 0:
        return flt(default_rate, 8)
    return None
